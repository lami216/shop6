                ...
                <div className='py-12'>
                        <div className='container mx-auto px-4'>
                                <h2 className='mb-4 text-center text-5xl font-bold sm:text-6xl'>
                                        <span className='bg-gradient-to-r from-bilady-gold via-bilady-gold/80 to-bilady-indigo bg-clip-text text-transparent'>
                                                        ...
                                                        {products.map((product) => {
                                                                ...
                                                                return (
                                                                        <div key={product._id} className='w-full flex-shrink-0 px-2 sm:w-1/2 lg:w-1/3 xl:w-1/4'>
                                                                                <div className='group flex h-full flex-col overflow-hidden rounded-xl border border-bilady-indigo/30 bg-white/5 shadow-lg backdrop-blur-sm transition-all duration-300 hover:border-bilady-gold/60 hover:shadow-xl'>
                                                                                        ...
                                                                                        <div className='p-4'>
                                                                                                ...
                                                                                                <div className='mb-4 flex flex-wrap items-baseline gap-2'>
                                                                                                        {isDiscounted ? (
                                                                                                                ...
                                                                                                                <span className='max-w-full break-words text-lg font-medium text-bilady-gold'>
                                                                                                                        {formatMRU(price)}
                                                                                                                </span>
                                                                                                        )}
                                                                                                </div>
                                                                                                <button
                                                                                                        ...
                                                                                                        className='flex w-full items-center justify-center gap-2 rounded bg-bilady-gold py-2 px-4 font-semibold text-bilady-navy transition-colors duration-300 hover:bg-[#b8873d]'
                                                                                                >
                                        ...
                                        <button
                                                ...
                                                className={`absolute top-1/2 -right-4 flex -translate-y-1/2 transform items-center justify-center rounded-full p-2 transition-colors duration-300 ${
                                                        isStartDisabled
                                                                ...
                                                                : "bg-bilady-indigo text-white hover:bg-[#3b3ad6]"
                                                }`}
                                        >
