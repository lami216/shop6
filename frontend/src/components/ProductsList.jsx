...
const ProductsList = ({ onEdit }) => {
        ...
        return (
                <motion.div
                        className='mx-auto max-w-4xl rounded-xl border border-bilady-indigo/40 bg-white/5 shadow-lg backdrop-blur-sm'
                ...
                >
                        <div className='overflow-x-auto'>
                                ...
                                <thead className='bg-bilady-navy/80'>
                                        <tr>
                                                {[ 
                                ...
                                <tbody className='divide-y divide-white/10 bg-white/5'>
                                        {products?.map((product) => (
                                                <tr key={product._id} className='transition-colors duration-200 hover:bg-bilady-navy/40'>
                                                        <td className='whitespace-nowrap px-6 py-4'>
                                                                <div className='flex items-center gap-3'>
                                                                        <div className='h-10 w-10 flex-shrink-0 overflow-hidden rounded-full ring-1 ring-bilady-indigo/40'>
                                                        ...
                                                        <td className='whitespace-nowrap px-6 py-4'>
                                                                <div className='flex flex-col items-end text-sm'>
                                                                        {product.isDiscounted && product.discountPercentage > 0 ? (
                                                                                ...
                                                                                <span className='text-bilady-gold'>
                                                                                        {formatMRU(product.price)}
                                                                                </span>
                                                                        )}
                                                                </div>
                                                                ...
                                                                <button
                                                                        ...
                                                                        className={`rounded-full p-1 transition-colors duration-200 ${
                                                                                product.isFeatured
                                                                                        ...
                                                                                        : "bg-bilady-navy/60 text-white/70"
                                                                        } hover:ring-2 hover:ring-bilady-indigo/40`}
                                                                >
                                                        ...
                                                        <td className='whitespace-nowrap px-6 py-4 text-sm font-medium'>
                                                                <div className='flex items-center justify-end gap-4'>
                                                                        <button
                                                                                ...
                                                                                className='inline-flex items-center text-white/80 transition-colors duration-200 hover:text-bilady-gold'
                                                                        >
